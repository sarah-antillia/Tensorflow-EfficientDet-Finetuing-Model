...
Please download the efficientdet model checkpoint file <b>efficientdet-d1.tar.gz</b>, and expand it under
...
, which is an image synthesis and autoannotation tool.<br>
 We need to test detection accuracy of this EfficientDet-US_RoadSigns_160classes Model by using actual road signs in US.<br>
